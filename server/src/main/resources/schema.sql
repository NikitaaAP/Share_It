...
CREATE TABLE IF NOT EXISTS item (
    ...
    CONSTRAINT FK_ITEM_ON_OWNER FOREIGN KEY (user_id) REFERENCES users (id),
...
CREATE TABLE IF NOT EXISTS booking (
    ...
    CONSTRAINT FK_BOOKING_ON_ITEM FOREIGN KEY (item_id) REFERENCES item (id)
    );
...
CREATE TABLE IF NOT EXISTS comment (
    ...
    CONSTRAINT FK_COMMENT_ON_ITEM FOREIGN KEY (item_id) REFERENCES item (id)
    );